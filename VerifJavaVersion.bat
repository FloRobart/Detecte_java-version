...
:: Permet de savoir si java existe, si ce n'est pas le cas ouvre une boite de dialogue puis télécharge java jdk 16 ::
java -version || (
...
:javaInvalide
    ...
    echo result = MsgBox("%~1%", vbYesNo+vbQuestion) > javaInvalide.vbs
